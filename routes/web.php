...
Route::middleware(['auth', 'user-access:siswa'])->group(function () {
    ...
    Route::get('/daftar-program', [SiswaController::class, 'daftarProgram'])->name('daftar-program');
});
...
Route::middleware(['auth', 'user-access:admin'])->group(function () {
    ...
    Route::delete('/admin/kelola-siswa/hapus', [KelolaSiswaController::class, 'hapus'])->name('admin.kelola-siswa.hapus');
